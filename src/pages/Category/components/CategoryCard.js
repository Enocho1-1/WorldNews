    ...
    <>
        <span className="mt-2 flex flex-col max-w-inherit w-[100%]">
            ...
            <div className="search-box h-[9rem] flex overflow-hidden">
                <img src={image_url === null || image_url.includes("gif") || image_url.includes("Linkedin") ? generic  : posterImage} onClick={() => navigateToArticlePage(navigate,title,data)}   className="searchquery-img h-inherit max-w-[10.938rem] w-[100%] hover:cursor-pointer" alt="news" />
