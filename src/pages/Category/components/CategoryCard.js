    ...
    <>
        <span className="mt-2 flex flex-col max-w-inherit w-[100%]">
            ...
            <div className="search-box flex overflow-hidden">
                <img src={image_url ? posterImage : generic} onClick={() => navigateToArticlePage(navigate,title,data)}   className="searchquery-img h-[150px] w-[200px] hover:cursor-pointer" alt="news" />
