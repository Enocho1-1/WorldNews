    ...
    <>
        <span className="mt-2 flex flex-col max-w-inherit w-[100%]">
            ...
            <div className="search-box h-[9rem] flex overflow-hidden">
                {!imgLoad ? <BlurEffect height="h-inherit" width="w-[100%]" maxWidth=" max-w-[10.938rem]"/> :  (<img src={posterImage} onClick={() => navigateToArticlePage(navigate,title,data)}   className="searchquery-img h-inherit max-w-[10.938rem] w-[100%] hover:cursor-pointer" alt="news" />)}
