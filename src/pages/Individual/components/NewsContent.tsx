        ...
        <aside className="mt-6 p-2 text-md">
         ...
         <div className="my-4 flex flex-wrap gap-y-2"> 
                {keywords? keywords.map((item,index) => (
                    <span key={index} className="border-l-4 border-dark_orange text-gray-500 h-[45px] max-w-[200px] text-md truncate ... mx-2 px-2 flex justify-center items-center">{item}</span>
                )): ""}
         </div> 
