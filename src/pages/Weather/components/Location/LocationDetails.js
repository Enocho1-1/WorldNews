    ...
    <>
         <header className="mt-8 flex">
              <span className="flex flex-col mx-4">
                <h1 className="font-roboto text-gray-800 text-3xl flex max-[1150px]:text-3xl">{location.toUpperCase()},{country} <img src={`https://flagsapi.com/${country}/shiny/64.png`} alt={country} className="h-10 w-10 ml-2 self-end" /></h1>
